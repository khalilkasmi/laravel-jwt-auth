...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    triggerLogin: function triggerLogin() {
      ...
      axios.get('/api/triggerLogin').then(function (response) {
    ...
    logout: function logout() {
      var vm = this;
      axios.post('http://localhost:8000/api/logout?token=' + vm.token).then(function (response) {
        vm.token = '';
        vm.user = null;
        vm.logged_out = true;
...
var render = function() {
  ...
  return _c("div", [
    _vm.logged_out
      ? _c("button", { on: { click: _vm.triggerLogin } }, [
...
var app = new Vue({
  el: '#app',
  components: {
    login: _components_loginComponent__WEBPACK_IMPORTED_MODULE_1__["default"]
  }
});
...
__webpack_require__(/*! C:\Users\khalil kasmi\Documents\studentdash\fullstack\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\khalil kasmi\Documents\studentdash\fullstack\resources\sass\app.scss */"./resources/sass/app.scss");
